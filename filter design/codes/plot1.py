...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.303', 'Epsilon = 0.46', 'Epsilon = 0.56', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
